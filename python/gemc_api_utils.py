"""=======================================
	...
	Any volume in the project is an instance of this class.  The "print_det" function writes out the volume parameters to the
	...
	factory			- The configuration factory defines how the generated files that gemc uses are stored.
                Currently this API only supports "TEXT".  Other choices might include "MYSQL" or a java format
...
def load_configuration(cFile):
	...
	with open(cFile,"r") as cn:
		for line in cn:
			if line.startswith("#") or line.isspace(): #XXX Its not clear what this if statement does?
				continue
...
if __name__ == "__main__":
	import argparse, sys
  #XXX This needs a proper readme
  #XXX Improve this argparse section
